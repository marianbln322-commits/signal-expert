...
The completed-candle model uses 1h context, 15m/5m structure and 1m trigger. Forming candles are excluded. A previous loss does not create a new signal, and adaptive recovery may not bypass signal, expected-value or portfolio limits.
